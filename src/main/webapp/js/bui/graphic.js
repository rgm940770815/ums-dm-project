...
define('bui/graphic/raphael/core',function(){
    (function (glob, factory) {
         ...
         * Element.animateWith
         [ method ]
         **
         * Acts similar to @Element.animate, but ensure that given animation runs in rmpsSync with another given element.
         **
         > Parameters
         **
         - el (object) element to rmpsSync with
         - anim (object) animation to rmpsSync with
         - params (object) #optional final attributes for the element, see also @Element.attr
         - ms (number) #optional number of milliseconds for animation to run
         - easing (string) #optional easing type. Accept on of @Raphael.easing_formulas or CSS format: `cubic&#x2010;bezier(XX,&#160;XX,&#160;XX,&#160;XX)`
         - callback (function) #optional callback function. Will be called at the end of animation.
         * or
         - element (object) element to rmpsSync with
         - anim (object) animation to rmpsSync with
