...
<div>
    <h1 class="centered" style="font-size: xx-large;font-weight: bold;padding-top: 1%;">退额法官统计</h1>

    <div id="searchDiv" class="searchDiv">
        <div class="centered">
            <label style="width: 110px; height: 30px;">退额时间范围：</label>
...
<script type="text/javascript">
    ...
    $("#countButton").click(function () {
        ...
        // 请求表格数据
        $.post("<%=basePath%>chart/getNewReportTable", {startDate: startDate, endDate: endDate, typeStr: "fss_01_13"}, function (result) {
    ...
    function todownLoad() {
        var fileName = "退额法官统计" + $("#startDate").val() + "--" + $("#endDate").val();
        $("#table").table2excel({
            exclude: ".noExl",
