<%--yefgcx：员额法官查询 2019年8月16日11:16:31--%>
...
<div class="panel">
    <div class="panel-header">
        <h3>人员信息自定义查询 --
            <button href="javascript:void(0)" onclick="saveEdit_grid_dialog.show()" class="button button-primary search">点击查询已保存搜索</button>
        </h3>
    </div>
    <div class="panel-body" style="height: 80%">
        ...
        <div id="list1" style="float: left"></div>
        ...
        <div id="content" hidden>
            <div id="form" class="control-group"></div>
        </div>
        ...
        <div hidden>
            <form id="redirect" action="customInfo.jsp"  method="post">
                <input name="redi">
            </form>
        </div>
                ...
                dialog = new Overlay.Dialog({
                    ...
                    buttons: [{
                        ...
                        handler: function () {
                            ...
                            // 限制必须为员额法院：(yefg = 1 or exists (select 1 from ums_level_info where user_id = a.id and n_level_type = 1 and is_yefg = 1 and n_present_info = 1))
                            $("#list3").append("<input sub='sub' term1='and (yefg = 1 ) and' term2='" + $('#list2 option:selected').attr("value") + "'" + " term3='" + $("#tj option:selected").val() + "' term4='" + term4 + "' term5='" + $('#list2 option:selected').attr("child_sql") + "' hidden>");
                            this.close();
                        }
                    }, {
                        text: '关闭',
