    ...
    <form id="detail" action="<%=basePath%>userinfo/attach/save" method="post">
        <div class="row">
            <div class="control-group span8">
                ...
                <div class="controls">
                    <select id="clerk_level" typeId="116" class="code field" data-rules="{required:true}"></select>
                </div>
            </div>
            <div class="control-group span8">
        ...
        <div class="row">
            <%--<div class="control-group span8">--%>
                ...
                <%--<div class="controls">--%>
                    <%--<input type="text" id="c_alt_basis" class="field control-text"--%>
                           <%--data-rules="{required:true, maxlength:150}">--%>
                <%--</div>--%>
            <%--</div>--%>
            <div class="control-group span8">
        ...
        <div class="hide">
            ...
            <input id="n_level_type" name="p.nLevelType" value="4">
...
<script>
    ...
    var otherParam = {"otherParam.n_level_type": "4"};
...
//                    dataIndex: 'sort_no',
    ...
    var formName = '书记员等级信息';

    //弹出层默认宽度
    var dialogWidth = 700;
    //弹出层默认高度
    var dialogHeight = 270;
    $(document).undelegate('#clerk_level', 'change').delegate('#clerk_level', 'change', function (ev) {
        if ($(this).val() == 89) {
