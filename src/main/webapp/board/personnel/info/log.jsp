    ...
    <script>
        ...
        BUI.use('common/search', function (Search) {
            ...
            var columns = [
                ...
                {title: '操作时间', dataIndex: 'opTime', width: 80, sortable: true, align: 'left'},
                {title: '用户ID', dataIndex: 'opUserId', width: 140, sortable: true, align: 'left'},
                {title: '操作用户', dataIndex: 'opUser', width: 100, sortable: true, align: 'left'},
                {title: '操作用户法院', dataIndex: 'opCourtNoText', width: 150, sortable: true, align: 'left'},
                {title: '被操作用户ID', dataIndex: 'userId', width: 140, sortable: true, align: 'left'},
                {title: '被操作用户法院', dataIndex: 'courtNoText', width: 150, sortable: true, align: 'left'},
                {title: '操作类型', dataIndex: 'opTypeText', width: 70, sortable: true, align: 'left'},
                {title: '操作内容', dataIndex: 'opContent', width: 550, align: 'left'},
                {title: '操作实体类id', dataIndex: 'entityId', width: 140, sortable: true, align: 'left'},
                {title: '操作IP', dataIndex: 'opIp', width: 100, sortable: true, align: 'left'}
            ];
