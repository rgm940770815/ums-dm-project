    ...
    <form id="enable_dialog_form" class="form-horizontal">
        <div class="row row_1">
            <div class="control-group span8">
                ...
                <div class="controls">
                    <select  typeId="45" class="leavecode" name="umsApplyForUpdate.leaveReason"  data-rules="{required:true}"></select>
                </div>
            </div>
            <div class="control-group span8">
                ...
                <div class="controls">
                    <select  typeId="46" class="code"
                            name="umsApplyForUpdate.leaveDestination"  data-rules="{required:true}"></select>
                </div>
            </div>
            <div class="control-group12 span8">
                ...
                <div class="controls">
                    <input  name="umsApplyForUpdate.leaveDate" type="text" class="calendar "
                           placeholder="调离日期" data-rules="{datecheck1:null,required:true}">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="control-group12 span8">
                ...
                <div class="controls">
                    <select name="umsApplyForUpdate.newValidCode" data-rules="{required:true}">
            ...
            <div class="control-group12 span8">
                ...
                <div class="controls">
                    <input  name="umsApplyForUpdate.contactNumber" type="text"
                            placeholder="联系电话" >
                </div>
            </div>
        ...
        function (Search, Tree, Data, Calendar, Overlay, Form, Uploader, Mask, Grid) {
            ...
            var columns = [
                ...
                },
                {
                    ...
                    title: '行政职务任职日期',
                    dataIndex: 'administrationPositionDate',
                    width: "120",
                    sortable: true,
                    align: 'left'
                }, {
                    title: '法律职务任职日期',
                    dataIndex: 'lawPositionDate',
                    width: "120",
                    sortable: true,
                    align: 'left'
                }, {
...
//                });
            ...
            function reloadUserinfo() {
                ...
                $("#userinfo_form [name^='otherfield.']").each(function () {
                    if (userinfo['otherfield'] != null) {
                        $(this).val(userinfo['otherfield'][$(this).attr("id")]);
                    }
                    $(this).attr("disabled", true);
                    if ($(this).hasClass("select22")) {
                        $(this).select2().select2("val", userinfo['otherfield'][$(this).attr("id")]);
                        $(this).change();
                    }
                });
