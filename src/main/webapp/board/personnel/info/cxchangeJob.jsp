...
//            {title: '用户id', dataIndex: 'user_id', width: 85, sortable: true, align: 'left'},
            ...
            {title: '申请理由', dataIndex: 'changeJobReason', width: 150, sortable: true, align: 'left'},
...
//            {title: '更新时间', dataIndex: 'update_time', width: 80, sortable: true, align: 'left'},
            {title: '申请状态', dataIndex: 'state', width: 70, sortable: true, align: 'left'},
            {
                ...
                if (obj.state !="申请中") {
                    ...
                    spanStr += '<span class="grid-command btn-re" >取消</span>';
                }
                return spanStr;
            },}
        ];
        var store = Search.createStore(url, {
                    ...
                    params:{
                        apply_court_no : '${loginUser.courtNo}'
                    },
                    autoLoad:true,
                    pageSize:20
                }),
...
//                    forceFit : true,
        ...
        var dform = new Form.HForm({
            ...
            callback: function (data) {
                if (data.job) {
                    BUI.Message.Alert("申请表更新成功!", null, "success");
                } else {
