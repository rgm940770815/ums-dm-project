<%--
    Document   : external_add2
    Created on : 2015-3-20, 10:53:10
    Author     : Diluka
--%>
                ...
                <div class="control-group span18">
                    ...
                    <div class="controls">
                        <input id="username" name="userInfo.username" type="text" placeholder="请输入用户名"
                               class="control-text" data-rules="{required:true}" onchange="cleanUserError()">
        ...
        <div id="ext-info">
            ...
            <div class="row">
                ...
                <div class="control-group span8" id="leaveTypeOther_div" style="display: none">
                    ...
                    <div class="controls">
                        <input type="text" class="control-text input-normal" id="leaveTypeOther"
                               name="info.leaveTypeOther" data-rules="{leaveTypeOther_required:''}"
                               placeholder="请输入其他离开情况" disabled data-depends="{'#leaveType:change':leaveTypeOther}">
                    </div>
                </div>
                <script>
        ...
        <div id="company-info">
            ...
            <div class="row">
                <div class="control-group span8">
                    ...
                    <div class="controls">
                        <input id="orgCode" name="company.orgCode" type="text" value=""
                               class="control-text input-normal" placeholder="组织机构代码">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="control-group span16">
                    ...
                    <div class="controls">
                        <input id="companyName" name="company.companyName" type="text" value=""
                               class="control-text input-large" placeholder="请输入公司名称"
                               data-rules="{company_required:null}"
                               data-depends="{'#companyInfoId:change':['clearErrors']}">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="control-group span16">
                    ...
                    <div class="controls">
                        <input id="address" name="company.address" type="text" value="" class="control-text input-large"
                               placeholder="请输入公司地址">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="control-group span8">
                    ...
                    <div class="controls">
                        <input id="contactName" name="company.contactName" type="text" class="control-text"
                               placeholder="联系人名称" data-rules="{company_required:null}"
                               data-depends="{'#companyInfoId:change':['clearErrors']}">
                    </div>
                </div>
                <div class="control-group span8">
                    ...
                    <div class="controls">
                        <input id="contactPhone" name="company.contactPhone" type="text" class="control-text"
                               placeholder="联系人电话">
                    </div>
                </div>
                <div class="control-group span8">
                    ...
                    <div class="controls">
                        <input id="contactMobile" name="company.contactMobile" type="text" class="control-text"
                               placeholder="联系人手机">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="control-group span8">
                    ...
                    <div class="controls">
                        <input id="legalPersonName" name="company.legalPersonName" type="text" class="control-text"
                               placeholder="法人名称">
                    </div>
                </div>
                <div class="control-group span8">
                    ...
                    <div class="controls">
                        <input id="legalPersonPhone" name="company.legalPersonPhone" type="text" class="control-text"
                               placeholder="法人电话">
                    </div>
                </div>
                <div class="control-group span8">
...
<script>
    ...
    if (isQuery == 10) {
        firstLine = '<option value=""></option>';
        $('[placeholder]').attr('placeholder', '');
        $('#leaveType').find('option:eq(0)').text('');
    }
    $(function () {
        ...
        if(isQuery == 10){
            ...
            $.getJSON("/ums/code/codeListByTypeWithNoAspect",
                    {},
                    function (data) {
                        if ($("#J_Form select[id='courtNo']").length > 0) {
                            $("#J_Form select[id='courtNo']").html("");
                            for (var i = 0; i < data.data.length; i++) {
                                $("#J_Form select[id='courtNo']").append($("<option>").attr({"value": data.data[i].courtCode}).text(data.data[i].codeName));
                            }
                        }
                    })
        }
...
<script>
    ...
    BUI.use(['common/search', 'bui/tree', 'bui/data', 'bui/calendar', 'bui/overlay', 'bui/form', 'bui/uploader', 'bui/select'],
            function (Search, Tree, Data, Calendar, Overlay, Form, Uploader, Select) {
                ...
                function reloadUserinfo() {
                    $(":input[name^='userInfo.']").each(function () {
                        ...
                        if(isQuery != 10 && $(this).hasClass("select22"))
                        {
                    ...
                    $.getJSON("<%=basePath%>photo/getPhotoById", {
                        userId: userinfo.id,
                        _: new Date().getTime()
                    }, function (data) {
                        if (data !== null) {
    ...
    function linkageChange(obj) {
        var timer = setTimeout(function () {
            if ($(obj).next().length > 0) {
                ...
                if (i == 1) {
                    objNext.attr("disabled", "disabled");
                } else {
