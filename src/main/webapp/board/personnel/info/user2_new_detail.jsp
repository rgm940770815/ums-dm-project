...
//                                    collapsed : true,
                    items: [{
                        id: 'base',
                        text: '基本信息',
                        href: '<%=basePath%>view/basicinfo_new?id=' + userId
                    }, {
                        id: 'changeInfo',
                        text: '人员变化信息',
                        ...
                        id: 'level_fg',
                        text: '法官等级信息',
                        href: '<%=basePath%>view/userinfo/page?viewName=levelInfo_fg&userId=' + userId
                    }, {
                        id: 'level_fj',
                        text: '法警职级等级信息',
                        href: '<%=basePath%>view/userinfo/page?viewName=levelInfo_fj&userId=' + userId
                    }, {
                        id: 'level_fgzl',
                        text: '法官助理等级信息',
                        href: '<%=basePath%>view/userinfo/page?viewName=levelInfo_fgzl&userId=' + userId
                    }, {
                        id: 'level_sjy',
                        text: '书记员等级信息',
                        href: '<%=basePath%>view/userinfo/page?viewName=levelInfo_sjy&userId=' + userId
                    }, {
                        id: 'servant',
                        text: '公务员级别',
                        ...
                        id: 'yxnqgb',
                        text: '优秀年轻干部信息集',
                        href: '<%=basePath%>view/userinfo/page?viewName=yxnqgb&userId=' + userId
                    }]
                }]
            },
                {
            ...
            if(userinfo.operator.fullname == '蒋昆' || userinfo.operator.fullname == '王其生'){
                config = [{
                    id: 'userinfo',
                    homePage: "base",
                    menu: [{
