        ...
        <div id="basic-info">
            ...
            <div class="row">
                <div class="control-group span8">
                    ...
                    <div class="controls">
                        <input id="birthplace" name="userInfo.birthplace" type="text" placeholder="请输入用户出生地" data-rules="{required:true}"
                               class="control-text">
                    </div>
                </div>
                <div class="control-group span8">
            ...
            <div class="row">
                <div class="control-group span8">
                    ...
                    <div class="controls">
                        <select id="personnelClassification" typeId="94" class="code" listType="tree2" data-rules="{required:true}"
                ...
                <div class="control-group12 span8">
                    ...
                    <div class="controls">
                        <select id="job" typeId="93" class="code" data-rules="{required:true}" name="userInfo.job"></select>
                    </div>
                </div>
                <div class="control-group span8">
                    ...
                    <div class="controls">
                        <select id="positionNature" data-rules="{required:true}" typeId="64" class="code select22"
                                name="userInfo.positionNature"></select>
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div id="position-info">
            ...
            <div class="row">
                ...
                <div class="control-group12 span8">
                    <label class="control-label"><s>*</s>任职日期：</label>
                    <div class="controls">
                        <input id="administrationPositionDate" name="userInfo.administrationPositionDate" type="text" placeholder="行政职务任职日期" disabled>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="control-group12 span8">
                    ...
                    <div class="controls">
                        <input id="rankDate" name="userInfo.rankDate" type="text" placeholder="职级日期" disabled>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="control-group12 span8">
                    ...
                    <div class="controls">
                        <select id="yefg" name="userInfo.yefg" disabled typeId="68" class="code"></select>
                    </div>
                </div>
                <div class="control-group span8">
                ...
                <div class="control-group12 span8">
                    ...
                    <div class="controls">
                        <input id="servantLevelDate" name="userInfo.servantLevelDate" type="text" placeholder="级别起算日期" disabled>
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div id="education-info">
            ...
            <div class="row">
                <div class="control-group12 span8">
                    ...
                    <div class="controls">
                        <input id="degreeDate" name="userInfo.degreeDate" type="text"
                               placeholder="获得学位日期" disabled>
                    </div>
                </div>
                <div class="control-group span8">
                ...
                <div class="control-group12 span8">
                    ...
                    <div class="controls">
                        <input id="lawyerCertDate" name="userInfo.lawyerCertDate" type="text"
                               class="calendar " placeholder="资格证书取得时间" data-rules="{required:true,datecheck1:null}">
                    </div>
                </div>
            </div>
                ...
                <div class="control-group12 span8">
                    ...
                    <div class="controls">
                        <input id="politicLawWorkDate" name="userInfo.politicLawWorkDate" type="text"
                               class="calendar " placeholder="政法工作日期" data-rules="{required:true,datecheck1:null}">
                    </div>
                </div>
                <div class="control-group12 span8">
                    ...
                    <div class="controls">
                        <input id="enterDate" name="userInfo.enterDate" type="text" class="calendar "
                               data-rules="{required:true,datecheck1:null}" onchange="courtTotal()" placeholder="进入本院日期">
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div id="dispatch-info">
            ...
            <div class="row">
                ...
                <div class="control-group span8">
                    ...
                    <div class="controls">
                        <select id="enterSource" typeId="114" class="code" data-rules="{required:true}" listType="tree2"
                ...
                <div class="control-group12 span8">
                    ...
                    <div class="controls">
                        <input id="verifyDate" name="userInfo.verifyDate" type="text" class="calendar "
                               placeholder="审核日期" data-rules="{required:true,datecheck1:null}">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="control-group12 span8">
                    ...
                    <div class="controls">
                        <input id="formerUnit" name="userInfo.formerUnit" type="text" value="" class="control-text"
                               placeholder="原单位" data-rules="{required:true}">
                    </div>
                </div>
            </div>
            <div class="row">
...
<%--                        <input name="userInfo.userStatus" type="checkbox" class="control-text"--%>
<%--                               data-rules="{required:true}">--%>
                    </div>
                </div>
            </div>
