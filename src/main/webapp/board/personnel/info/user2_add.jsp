        ...
        <div id="basic-info">
            ...
            <div class="row">
                ...
                <div class="control-group12 span8">
                    ...
                    <div class="controls">
                        ...
                        data-rules="{datecheck1:null}" onchange="calcAge()">
            ...
            <div class="row" style="height:80px;">
                <div class="control-group span">
                    ...
                    <div class="controls">
                        <textarea id="bzxx" name="userInfo.bzxx"  class="control-text" style="width: 780px;height: 60px;resize: none"
        ...
        <div id="position-info">
            ...
            <div class="row">
                <div class="control-group12 span8">
                    ...
                    <div class="controls">
                        <select id="yefg" name="userInfo.yefg" data-rules="{required:true}" typeId="68" class="code select22">
                        </select>
                    </div>
                </div>
                <div class="control-group span8">
                ...
                <div class="control-group span8">
                    ...
                    <div class="controls">
                        <select id="lawPositionReport" typeId="1016" class="code select22" data-rules="{required:true}" name="userInfo.lawPositionReport"></select>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="control-group span8">
                    ...
                    <div class="controls">
                        <select id="administrationPositionReport" data-rules="{required:true}" typeId="1015" class="code select22"
                                name="userInfo.administrationPositionReport"></select>
                    </div>
                </div>
                <div class="control-group12 span8">
                    <label class="control-label">任职日期：</label>
            ...
            <div class="row">
                ...
                <div class="control-group span8">
                    <label class="control-label"><s>*</s>职级类型(最高院)：</label>

                    <div class="controls">
                        <select id="rankReport" typeId="1017" class="code select22" data-rules="{required:true}"name="userInfo.rankReport"></select>
                    </div>
                </div>
                <div class="control-group12 span8">
        ...
        <div id="education-info">
            ...
            <div class="row">
                ...
                <div class="control-group span8">
                    ...
                    <div class="controls">
                        <select id="educationBackgroundReport" data-rules="{required:true}" typeId="1011" class="code select22"
                                name="userInfo.educationBackgroundReport"></select>
                    </div>
                </div>
                <div class="control-group span8">
