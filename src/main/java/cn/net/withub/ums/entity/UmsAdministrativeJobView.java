...
public class UmsAdministrativeJobView {
    /**
     * 
     */
    private String id;
    ...
    public String getnExtraJobText() {
        return nExtraJobText;
    }

    public void setnExtraJobText(String nExtraJobText) {
        this.nExtraJobText = nExtraJobText == null ? null : nExtraJobText.trim();
    }
}