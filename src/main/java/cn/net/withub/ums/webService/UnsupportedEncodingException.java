...
public class UnsupportedEncodingException  extends cn.net.withub.ums.webService.IOException  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://io.java", "UnsupportedEncodingException"));
    }
